                        ...
                        <div class="panel-body">
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group {{$errors->first('section_name') ? 'has-error' : NULL}} xs-pt-10">
                                    ...
                                    <input class="form-control input-sm" value="{{old('section_name')}}" placeholder="Enter Section Name" type="text" name="section_name">
                                ...
                                <div class="form-group {{$errors->first('adviser_id') ? 'has-error' : NULL}} xs-pt-10">
                                    ...
                                    {{Form::select('adviser_id',$teachers,old('adviser_id'),['class' => "form-control select input-sm"])}}
