                            ...
                            <table class="table table-condensed table-hover table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><strong>{{$student->lrn}}</strong></td>
                                        <td>{{"{$student->lname}, {$student->fname} {$student->mname}"}}</td>
                                        <td><input readonly="readonly" type="number" min="0" max="100" step="any" value="{{round($subject->class_record($class->id,$subject->id,$student->id)->first_grading,2)}}" class="form-control input-sm" name="1st_grading[{{$student->id}}]"></td>
                                        <td><input readonly="readonly" type="number" min="0" max="100" step="any" value="{{round($subject->class_record($class->id,$subject->id,$student->id)->second_grading,2)}}" class="form-control input-sm" name="2nd_grading[{{$student->id}}]"></td>
                                        <td><input readonly="readonly" type="number" min="0" max="100" step="any" value="{{round($subject->class_record($class->id,$subject->id,$student->id)->third_grading,2)}}" class="form-control input-sm" name="3rd_grading[{{$student->id}}]"></td>
                                        <td><input readonly="readonly" type="number" min="0" max="100" step="any" value="{{round($subject->class_record($class->id,$subject->id,$student->id)->fourth_grading,2)}}" class="form-control input-sm" name="4th_grading[{{$student->id}}]"></td>
