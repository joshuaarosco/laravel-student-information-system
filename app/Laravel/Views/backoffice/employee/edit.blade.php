                        ...
                        <div class="panel-body">
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group {{$errors->first('fname') ? 'has-error' : NULL}} xs-pt-10">
                                    <label class="control-label">First Name</label> <input class="form-control input-sm" value="{{old('fname',$employee->fname)}}" placeholder="Enter First Name" type="text" name="fname">
                                ...
                                <div class="form-group {{$errors->first('lname') ? 'has-error' : NULL}}">
                                    <label class="control-label">Last Name</label> <input class="form-control input-sm" value="{{old('lname',$employee->lname)}}" placeholder="Enter Last Name" type="text" name="lname">
                                ...
                                <div class="form-group {{$errors->first('username') ? 'has-error' : NULL}}">
                                    <label class="control-label">Username</label> <input class="form-control input-sm" value="{{old('username',$employee->username)}}" placeholder="Enter Username" type="text" name="username">
                                ...
                                <div class="form-group {{$errors->first('type') ? 'has-error' : NULL}}">
                                    ...
                                    {!!Form::select("type", $types, old('type',$employee->type), ['id' => "type", 'class' => "form-control input-sm"]) !!}
                                ...
                                <div class="form-group {{$errors->first('email') ? 'has-error' : NULL}}">
                                    <label class="control-label">Email address</label> <input class="form-control input-sm" value="{{old('email',$employee->email)}}" placeholder="Enter email" type="email" name="email">
