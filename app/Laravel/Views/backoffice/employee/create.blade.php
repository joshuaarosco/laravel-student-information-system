                        ...
                        <div class="panel-body">
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group {{$errors->first('fname') ? 'has-error' : NULL}} xs-pt-10">
                                    <label class="control-label">First Name</label> <input class="form-control input-sm" value="{{old('fname')}}" placeholder="Enter First Name" type="text" name="fname">
                                ...
                                <div class="form-group {{$errors->first('lname') ? 'has-error' : NULL}}">
                                    <label class="control-label">Last Name</label> <input class="form-control input-sm" value="{{old('lname')}}" placeholder="Enter Last Name" type="text" name="lname">
                                ...
                                <div class="form-group {{$errors->first('username') ? 'has-error' : NULL}}">
                                    <label class="control-label">Username</label> <input class="form-control input-sm" value="{{old('username')}}" placeholder="Enter Username" type="text" name="username">
                                ...
                                <div class="form-group {{$errors->first('type') ? 'has-error' : NULL}}">
                                    ...
                                    {!!Form::select("type", $types, old('type'), ['id' => "type", 'class' => "form-control input-sm"]) !!}
                                ...
                                <div class="form-group {{$errors->first('email') ? 'has-error' : NULL}}">
                                    <label class="control-label">Email address</label> <input class="form-control input-sm" value="{{old('email')}}" placeholder="Enter email" type="email" name="email">
                                ...
                                <div class="form-group {{$errors->first('password') ? 'has-error' : NULL}}">
                                    <label class="control-label">Password</label> <input class="form-control input-sm" value="" placeholder="Password" type="password" name="password">
                                ...
                                <div class="form-group {{$errors->first('password_confirmation') ? 'has-error' : NULL}}">
                                    <label class="control-label">Password Confirmation</label> <input class="form-control input-sm" value="" placeholder="Confirm Password" type="password" name="password_confirmation">
