                            ...
                            <table class="table table-striped table-hover table-fw-widget" id="table1">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        <td>{{$index+1}}</td>
                                        <td>
                                            <img src="{{asset($info->directory.'/'.$info->filename)}}" alt="" class="img-thumbnail" width="150">
                                        </td>
                                        <td>{{$info->title}}</td>
                                        <td>{{$info->author}}</td>
                                        <td>{{Str::limit(strip_tags($info->content),$limit=100)}}</td>
                                        <td>{{Helper::date_format($info->posted_at,'F d, Y')}}</td>
                                        <td class="actions">
