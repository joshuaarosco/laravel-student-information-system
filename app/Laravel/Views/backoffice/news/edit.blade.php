                        ...
                        <div class="panel-body">
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group {{$errors->first('title') ? 'has-error' : NULL}} xs-pt-10">
                                    ...
                                    <input class="form-control input-sm" value="{{old('title',$news->title)}}" placeholder="Enter Title" type="text" name="title">
                                ...
                                <div class="form-group {{$errors->first('author') ? 'has-error' : NULL}}">
                                    ...
                                    <input class="form-control input-sm" value="{{old('author',$news->author)}}" placeholder="Enter Author" type="text" name="author">
                                ...
                                <div class="form-group {{$errors->first('content') ? 'has-error' : NULL}}">
                                    ...
                                    <textarea class="summernote" value="" placeholder="Enter Last Name" type="text" name="content">{{old('content',$news->content)}}</textarea>
                                ...
                                <div class="form-group {{$errors->first('posted_at') ? 'has-error' : NULL}} xs-pt-10">
                                    ...
                                    <input class="form-control input-sm" value="{{old('posted_at',$news->posted_at)}}" placeholder="Enter Posted At" type="date" name="posted_at">
