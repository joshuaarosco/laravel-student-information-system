                        ...
                        <div class="panel-body">
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group {{$errors->first('section_id') ? 'has-error' : NULL}} xs-pt-10">
                                    ...
                                    {!!Form::select('section_id',$sections,old('section_id'),['class' => "form-control input-sm"])!!}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {{$errors->first('student_ids') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            {!!Form::select('student_ids[]',$students,old('student_ids'),['class'=>"", 'multiple' => "multiple" , 'id' => "searchable"])!!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{$errors->first('subject_ids') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            {!!Form::select('subject_ids[]',$subjects,old('subject_ids'),['class'=>"", 'multiple' => "multiple" , 'id' => "my-select"])!!}
