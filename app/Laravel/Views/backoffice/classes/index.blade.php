                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-hover table-fw-widget" id="table1">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        <td>{{ $index+1 }}</td>
                                        <td><a href="{{route('backoffice.classes.students',$info->id)}}"><strong>{{ $info->class_code }}</strong></a></td>
                                        <td><strong>{{ $info->section?$info->section->school_year : '---' }}</strong> - {{ $info->section?$info->section->section_name : '---'}}</td>
                                        <td>{{ $info->subjects(explode(', ',$info->subject_ids)) }}</td>
                                        <td>{{ count(explode(', ',$info->student_ids)) }}</td>
