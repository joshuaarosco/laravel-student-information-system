                        ...
                        <div class="panel-body">
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group {{$errors->first('teacher_id') ? 'has-error' : NULL}} xs-pt-10">
                                    ...
                                    {{Form::select('teacher_id',$teachers,old('teacher_id'),['class' => "form-control select input-sm"])}}
                                ...
                                <div class="form-group {{$errors->first('school_year') ? 'has-error' : NULL}} xs-pt-10">
                                    ...
                                    <input class="form-control input-sm" value="{{old('school_year')}}" placeholder="Enter School Year" type="text" name="school_year">
                                ...
                                <div class="form-group {{$errors->first('subject_title') ? 'has-error' : NULL}} xs-pt-10">
                                    ...
                                    <input class="form-control input-sm" value="{{old('subject_title')}}" placeholder="Enter Subject Title" type="text" name="subject_title">
