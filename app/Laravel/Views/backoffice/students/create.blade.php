                        ...
                        <div class="panel-body">
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group {{$errors->first('contact_number') ? 'has-error' : NULL}} xs-pt-10">
                                    ...
                                    <input class="form-control input-sm" value="{{old('contact_number')}}" placeholder="Enter Contact Number" type="text" name="contact_number">
                                    @if($errors->first('contact_number'))
                                    <span class="help-block">{!!$errors->first('contact_number')!!}</span>
                                    @endif
                                </div>

                                <div class="form-group {{$errors->first('address') ? 'has-error' : NULL}} xs-pt-10">
                                    <label class="control-label">Address</label> 
                                    <textarea class="form-control input-sm" value="" placeholder="Enter Address" type="text" name="address">{{old('address')}}</textarea> 
