                        ...
                        <div class="panel-body">
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group {{$errors->first('lrn') ? 'has-error' : NULL}} xs-pt-10">
                                    ...
                                    <input class="form-control input-sm" value="{{old('lrn')}}" placeholder="Enter LRN" type="text" name="lrn">
                                    @if($errors->first('lrn'))
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group {{$errors->first('fname') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            <input class="form-control input-sm" value="{{old('fname')}}" placeholder="Enter First Name" type="text" name="fname">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{$errors->first('mname') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            <input class="form-control input-sm" value="{{old('mname')}}" placeholder="Enter Middle Names" type="text" name="mname">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{$errors->first('lname') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            <input class="form-control input-sm" value="{{old('lname')}}" placeholder="Enter Last Name" type="text" name="lname">
                                ...
                                <div class="form-group {{$errors->first('gender') ? 'has-error' : NULL}} xs-pt-10">
                                    ...
                                    {!!Form::select('gender',$gender,old('gender'),['class'=>"form-control input-sm"])!!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{$errors->first('age_of_first_friday_june') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            <input type="text" name="age_of_first_friday_june" value="{{old('age_of_first_friday_june')}}" placeholder="Age as of 1st Friday June" class="form-control input-sm">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{$errors->first('mother_tounge') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            <input type="text" name="mother_tounge" value="{{old('mother_tounge')}}" placeholder="Mother Tounge" class="form-control input-sm">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {{$errors->first('ip') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            <input type="text" name="ip" value="{{old('ip')}}" placeholder="IP (Ethnic Group)" class="form-control input-sm">
                                            @if($errors->first('ip'))
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{$errors->first('religion') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            <input type="text" name="religion" value="{{old('religion')}}" placeholder="Religion" class="form-control input-sm">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {{$errors->first('house_street') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            <input class="form-control input-sm" value="{{old('house_street')}}" type="text" placeholder="House #/ Street/ Sitio/ Purok" name="house_street">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{$errors->first('barangay') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            <input class="form-control input-sm" value="{{old('barangay')}}" type="text" placeholder="Barangay" name="barangay">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {{$errors->first('municipality') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            <input class="form-control input-sm" value="{{old('municipality')}}" type="text" placeholder="Municipality" name="municipality">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{$errors->first('province') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            <input class="form-control input-sm" value="{{old('province')}}" type="text" placeholder="Province" name="province">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {{$errors->first('fathers_name') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            <input class="form-control input-sm" value="{{old('fathers_name')}}" placeholder="(Last Name, First Name Middle Name)" type="text" name="fathers_name">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{$errors->first('mothers_name') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            <input class="form-control input-sm" value="{{old('mothers_name')}}" placeholder="(Last Name, First Name Middle Name)" type="text" name="mothers_name">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group {{$errors->first('guardian_name') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            <input class="form-control input-sm" value="{{old('guardian_name')}}" placeholder="(Last Name, First Name Middle Name)" type="text" name="guardian_name">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{$errors->first('relationship') ? 'has-error' : NULL}} xs-pt-10">
                                            ...
                                            <input class="form-control input-sm" value="{{old('relationship')}}" type="text" placeholder="Relationship" name="relationship">
                                ...
                                <div class="form-group {{$errors->first('contact_number') ? 'has-error' : NULL}} xs-pt-10">
                                    ...
                                    <input class="form-control input-sm" value="{{old('contact_number')}}" type="text" placeholder="Contact Number" name="contact_number">
                                ...
                                <div class="form-group {{$errors->first('remarks') ? 'has-error' : NULL}} xs-pt-10">
                                    ...
                                    <textarea class="form-control input-sm" value="" placeholder="Enter Remarks" type="text" name="remarks">{{old('remarks')}}</textarea> 
