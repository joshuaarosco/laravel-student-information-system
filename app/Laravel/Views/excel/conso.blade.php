...
<body>
	...
	<table>
		<tr>
			...
			<td style="border: 3px solid #000; font-size: 12px; width: 20%;" rowspan="5"><center style="text-align: center;" >LRN</center></td>
		...
		<tr>
			...
			<td style="border: 3px solid #000; font-size: 12px;"></td>
			<td style="border: 3px solid #000; font-size: 12px; width: 30%;">SCHOOL YEAR: {{$section->school_year}}</td>
			@foreach($subjects as $index => $subject)
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 15%;" colspan="5"><span style="text-align: center;">TCHR: {{"{$subject->teacher->lname}, {$subject->teacher->fname}"}}</span></td>
			@endforeach
		...
		<tr>
			...
			@foreach($subjects as $index => $subject)
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;">1</td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;">2</td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;">3</td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;">4</td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;">AVE</td>
			@endforeach
			@foreach(range(1, 10) as $value)
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;">AVE</td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;">RANK</td>
			@endforeach
		</tr>
		...
		<tr>
			...
			?>
			@foreach($subjects as $index => $subject)
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;">
			...
			?>
			@endforeach
			{{-- <td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong>{{round(array_sum($first_grading)/count($first_grading),2)}}</strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong></strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong>{{round(array_sum($second_grading)/count($second_grading),2)}}</strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong></strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong>{{round(array_sum($third_grading)/count($third_grading),2)}}</strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong></strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong>{{round(array_sum($fourth_grading)/count($fourth_grading),2)}}</strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong></strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong>{{round(array_sum($average)/count($average),2)}}</strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong></strong></td>

			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong>{{round(array_sum($first_grading)/count($first_grading),0)}}</strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong></strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong>{{round(array_sum($second_grading)/count($second_grading),0)}}</strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong></strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong>{{round(array_sum($third_grading)/count($third_grading),0)}}</strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong></strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong>{{round(array_sum($fourth_grading)/count($fourth_grading),0)}}</strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong></strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong>{{round(array_sum($average)/count($average),0)}}</strong></td>
			<td style="border: 3px solid #000; font-size: 12px; text-align: center; width: 10px;"><strong></strong></td> --}}
		</tr>
		@endforeach
	</table>
