...
class GiftDeclinedNotification extends MainNotification
{
    ...
    public function __construct(WishlistTransaction $wishlist_transaction)
    {
        ...
        $data = [
            ...
            'title' => Helper::get_response_message("GIFT_DECLINED_NOTIFICATION_TITLE", ['name' => $owner, 'wishlist' => $wishlist]),
            'content' => Helper::get_response_message("GIFT_DECLINED_NOTIFICATION_CONTENT", ['name' => $owner, 'wishlist' => $wishlist]),
