...
class PermissionGrantedNotification extends SelfNotification
{
    ...
    public function __construct(WishlistViewer $wishlist_viewer)
    {
        ...
        $data = [
            ...
            'title' => Helper::get_response_message("SELF_PERMISSION_GRANTED_NOTIFICATION_TITLE", ['name' => $viewer]),
            'content' => Helper::get_response_message("SELF_PERMISSION_GRANTED_NOTIFICATION_CONTENT", ['name' => $viewer]),
            'thumbnail' => $thumbnail,
        ];
