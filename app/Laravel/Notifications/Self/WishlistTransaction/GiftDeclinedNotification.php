...
class GiftDeclinedNotification extends SelfNotification
{
    ...
    public function __construct(WishlistTransaction $wishlist_transaction)
    {
        ...
        $data = [
            ...
            'title' => Helper::get_response_message("SELF_GIFT_DECLINED_NOTIFICATION_TITLE", ['wishlist' => $wishlist]),
            'content' => Helper::get_response_message("SELF_GIFT_DECLINED_NOTIFICATION_CONTENT", ['name' => $sender, 'wishlist' => $wishlist]),
