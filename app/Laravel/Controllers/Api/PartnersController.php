...
use App\Laravel\Transformers\PartnersTransformer;
...
class PartnersController extends Controller{
	...
	*/
	...
	public function all($format = ""){
		try{
			$this->response['msg'] = "Partners Lists";
			$this->response['status_code'] = "PARTNERS_LISTS";
			$this->response['status'] = TRUE;
			$this->response_code = 200;
			$partners = Partner::all();
			$this->response['data'] = $this->transformer->transform($partners,new PartnersTransformer,'collection');
	...
	public function show($format = ""){
		try{
			...
			if($partner){
				$this->response['data'] = $this->transformer->transform($partner,new PartnersTransformer,'item');
			}
