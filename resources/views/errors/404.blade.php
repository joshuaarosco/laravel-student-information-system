...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('backoffice/app-assets/css/pages/error.min.css')}}">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
  ...
  <body data-open="click" data-menu="horizontal-menu" data-col="1-column" class="horizontal-layout horizontal-menu 1-column  blank-page blank-page">
    ...
    <div class="card-body collapse in">
        ...
        {{-- <div class="row py-2">
            <div class="col-xs-12 col-sm-6 col-md-6">
                <a href="index.html" class="btn btn-primary btn-block font-small-3"><i class="ft-home"></i> Back to Home</a>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6">
    ...
    <script src="{{asset('backoffice/app-assets/js/scripts/forms/form-login-register.min.js')}}" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
  </body>
</html>